...
p("The interface originally used Gradio's default styling, which is functional but "
  ...
  "HTML, so that every built-in component, buttons, sliders, checkboxes, accordions, "
  "still behaves and responds exactly as Gradio intends while presenting a warm, "
